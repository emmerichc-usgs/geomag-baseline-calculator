...
class ObservationFactory {
	 ...
	 *      Can throw an exception if an SQL error occurs. See "triggerError"
	 */
	private function createMeasurements($measurements, $id) {
	 ...
	 *      Can throw an exception if an SQL error occurs. See "triggerError"
	 */
	private function createReadings($readings, $id) {
	 ...
	 *      Can throw an exception if an SQL error occurs. See "triggerError"
	 */
	private function deleteMeasurements($id) {
	 ...
	 *      Can throw an exception if an SQL error occurs. See "triggerError"
	 */
	private function deleteReadings($id) {
